...
public class WeatherEngine implements NetworkThread.NetworkInterfaceCallback
{
    ...
    public void getWeatherData(String city)
    {
        ...
        NetworkThread getter = new NetworkThread(this, url);
        getter.start();
    }
